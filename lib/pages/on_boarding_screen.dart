...
class _OnBoardingScreen extends State<OnBoardingScreen> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(statusBarColor: Color.fromRGBO(255, 255, 255, 1),statusBarIconBrightness: Brightness.dark,));
    return Scaffold(
    ...
    return Row(children: [
      Container(
          ...
          decoration: BoxDecoration(
            ...
            color: index == _pageIndex ? Color.fromRGBO(39, 145, 181, 1) : Color.fromRGBO(214, 218, 219, 1),
          ))
    ]);
  }
}
